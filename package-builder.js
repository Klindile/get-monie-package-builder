  ...
  eventTypes: [
    {
      ...
      imageUrl: "https://files.fm/f/jc6nsgmey4" // Updated with engagement link
    },
    {
      id: "small-event",
      name: "Small Event",
      description: "Perfect for birthdays, parties, and gatherings",
      imageUrl: "https://adobe.ly/4cuthwL" // Kept existing link
    },
    {
      id: "production",
      name: "Production",
      description: "Commercial, product, and promotional content",
      imageUrl: "https://files.fm/f/7q9hsapjas" // Updated with production link
    },
    {
      id: "portrait",
      name: "Portrait Session",
      description: "Individual or family portrait photography",
      imageUrl: "https://files.fm/f/9pr7ptdm7z" // Updated with graduation link
    }
  ],
  serviceTypes: [
    {
      ...
      imageUrl: "https://files.fm/f/2sasvmkwcu" // Updated with specialty photography link
    },
    {
      id: "videography",
      name: "Videography",
      description: "Professional videography services",
      imageUrl: "https://adobe.ly/4j4l18V" // Kept existing link
    },
    {
      id: "both",
      name: "Photography & Videography",
      description: "Comprehensive photo and video coverage",
      imageUrl: "https://adobe.ly/3Ee1hRj" // Kept existing link
    }
  ],
  packages: {
    // --- WEDDING ---
    ...
    "small-event-both": [
      ...
      },
      {
        ...
        // Note: There was a duplicate "small-event-both" entry here in the original code. I have kept only the first one.
        // If the second entry with A, B, C, S packages was intended for small events, please let me know.
