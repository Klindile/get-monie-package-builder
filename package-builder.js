...
const packageData = {
  eventTypes: [
    ...
    },
    {
      ...
      imageUrl: "images/prod.jpg" // <-- Updated to use local image path
    },
    {
      id: "portrait",
  ...
  packages: {
    ...
    "wedding-videography": [
      {
        id: "basic", name: "Essential", price: 1500, description: "Capture the key moments of your special day",
        features: ["6 hours of coverage", "1 videographer", "3-5 minute highlight film", "Digital delivery", "1 revision"]
      },
      {
        id: "standard", name: "Classic", price: 2500, description: "Comprehensive video coverage of your wedding day",
        features: ["8 hours of coverage", "2 videographers", "5-7 minute highlight film", "30-minute feature film", "Digital delivery", "2 revisions", "Drone footage (weather permitting)"]
      },
      {
        id: "premium", name: "Luxury", price: 4000, description: "Premium video coverage with all the extras",
        features: ["10 hours of coverage", "2 videographers", "7-10 minute highlight film", "60-minute feature film", "Raw footage of ceremony and speeches", "Digital delivery", "3 revisions", "Drone footage (weather permitting)", "Same-day edit for reception viewing"]
      }
    ],
    "wedding-both": [
      {
        id: "basic", name: "Essential", price: 2500, description: "Essential photo and video coverage for your wedding",
        features: ["6 hours of coverage", "1 photographer", "1 videographer", "100+ edited digital images", "3-5 minute highlight film", "Online gallery", "Digital delivery", "Print release", "1 revision (video)"]
      },
      {
        id: "standard", name: "Classic", price: 4000, description: "Our most popular combined package",
        features: ["8 hours of coverage", "2 photographers", "2 videographers", "Engagement session", "300+ edited digital images", "5-7 minute highlight film", "30-minute feature film", "Online gallery", "Digital delivery", "Print release", "Wedding album (8x8, 20 pages)", "2 revisions (video)", "Drone footage (weather permitting)"]
      },
      {
        id: "premium", name: "Luxury", price: 7000, description: "The ultimate wedding photo and video experience",
        features: ["10 hours of coverage", "2 photographers", "2 videographers", "Engagement session", "Bridal session", "500+ edited digital images", "7-10 minute highlight film", "60-minute feature film", "Raw footage of ceremony and speeches", "Online gallery", "Digital delivery", "Print release", "Premium wedding album (10x10, 30 pages)", "2 parent albums", "16x20 canvas print", "3 revisions (video)", "Drone footage (weather permitting)", "Same-day edit for reception viewing"]
      }
    ],
    // --- SMALL EVENT ---
    "small-event-photography": [
      ...
      },
      {
        ...
        features: ["4 hours of coverage", "1 photographer", "Online gallery", "100+ edited digital images", "Print release" /* Removed photo book */]
      },
      {
        id: "premium", name: "Luxury", price: 1200, description: "Premium coverage for important celebrations",
        features: ["6 hours of coverage", "1 photographer", "Online gallery", "200+ edited digital images", "Print release", /* Removed photo book */ "16x20 mounted print"]
      }
    ],
    ...
    "small-event-both": [
      ...
      },
      {
        ...
        features: ["4 hours of coverage", "1 photographer", "1 videographer", "100+ edited digital images", "3-5 minute highlight film", "15-minute feature film", "Online gallery", "Digital delivery", "Print release", /* Removed photo book */ "2 revisions (video)"]
      },
      {
        id: "premium", name: "Luxury", price: 2500, description: "Premium photo and video coverage for special celebrations",
        features: ["6 hours of coverage", "1 photographer", "2 videographers", "200+ edited digital images", "5-7 minute highlight film", "30-minute feature film", "Online gallery", "Digital delivery", "Print release", /* Removed photo book */ "16x20 mounted print", "3 revisions (video)", "Drone footage (weather permitting)"]
      }
    ],
    // --- PRODUCTION ---
    ...
    "portrait-photography": [
      {
        id: "basic", name: "Essential", price: 200, description: "Perfect for individuals or couples",
        features: ["1 hour session", "1 location", "1 outfit change", "Online gallery", "10 edited digital images", "Print release"]
      },
      {
        id: "standard", name: "Classic", price: 350, description: "Ideal for individuals, couples, or small families",
        features: ["1.5 hour session", "2 locations", "2 outfit changes", "Online gallery", "20 edited digital images", "Print release", "8x10 mounted print"]
      },
      {
        id: "premium", name: "Luxury", price: 600, description: "Comprehensive portrait session for families or groups",
        features: ["2 hour session", "Multiple locations", "3 outfit changes", "Online gallery", "30 edited digital images", "Print release", /* Removed photo book */ "11x14 mounted print", "Short video reel (<60s)" /* Removed hair/makeup, added reel */]
      }
    ],
    "portrait-videography": [
      ...
      },
      {
        ...
        features: ["2 hour session", "Multiple locations", "3-4 minute main stylized video", "Additional 30-second social media cut", "Digital delivery", "Unlimited revisions", "Licensed music", "Drone footage (weather permitting)", "Short video reel (<60s)" /* Removed hair/makeup, added reel */]
      }
    ],
    "portrait-both": [
       {
  ...
  addOns: {
    ...
    photography: [
      ...
      // *** MODIFIED ***
      { id: "additional-edits", name: "Additional Edited Images", price: 50, description: "Per 5 additional edited pictures", category: "Digital", compatibleEvents: ["wedding", "small-event", "production", "portrait"] },
      // *** MODIFIED ***
  ...
  if (currentState.selectedAddOns.length === 0) {
    ...
    currentState.selectedAddOns.forEach(addon => {
      ...
      removeButton.onclick = () => { // Use onclick for simplicity here
          ...
          const addOnCard = domElements.addOnsGrid.querySelector(`.add-on-card[data-id="${addon.id}"]`);
...
function goToNextStep() {
  // Add validation if needed (e.g., ensure a selection is made)
  if (currentState.step === 1 && !currentState.eventType) return;
  if (currentState.step === 2 && !currentState.serviceType) return;
  if (currentState.step === 3 && !currentState.basePackage) return;
